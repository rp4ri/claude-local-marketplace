...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/bug-hunter-state.cjs" init ".bug-hunter/state.json" "extended" ".bug-hunter/source-files.json" 30
```
...
3. Record findings and mark done:
   ```bash
   node "${CLAUDE_PLUGIN_ROOT}/scripts/bug-hunter-state.cjs" record-findings ".bug-hunter/state.json" ".bug-hunter/chunk-<id>-findings.json" "extended"
