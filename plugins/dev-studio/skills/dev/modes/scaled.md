...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/bug-hunter-state.cjs" init ".bug-hunter/state.json" "scaled" ".bug-hunter/source-files.json" 30
```
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/bug-hunter-state.cjs" hash-filter ".bug-hunter/state.json" ".bug-hunter/chunk-<id>-files.json"
```
