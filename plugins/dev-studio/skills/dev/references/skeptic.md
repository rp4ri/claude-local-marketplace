...
For validation methodology examples (2 confirmed + 2 false positives correctly caught + 1 manual review), read `${CLAUDE_PLUGIN_ROOT}/skills/dev/examples/skeptic-examples.md` before starting your challenges.
