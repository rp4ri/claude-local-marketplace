...
function requiredScripts(skillDir) {
  return [
    ...
    // Core agent skills (adapted to plugin structure)
    path.join(skillDir, 'skills', 'dev', 'references', 'hunter.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'skeptic.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'referee.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'fixer.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'recon.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'doc-lookup.md'),
    // Security skills
    path.join(skillDir, 'skills', 'dev', 'references', 'threat-model.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'commit-scan.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'security-review.md'),
    path.join(skillDir, 'skills', 'dev', 'references', 'vuln-validation.md')
  ];
}
