#!/usr/bin/env python3
"""
Prospect Analyzer — Sales Studio
Fetches a company website and extracts structured data for prospect analysis.

Zero external dependencies — uses only Python stdlib (urllib, html.parser, json, re).
...
def main():
    parser = argparse.ArgumentParser(
        description="Prospect Analyzer — Sales Studio. Fetch and analyze a company website for sales intelligence.",
